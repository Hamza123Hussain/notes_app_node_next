...
const NoteTrigger = ({ Note }: { Note: Note }) => {
  return (
    <div
      ...
      className=" flex flex-col hover:shadow-sm hover:shadow-amber-900 justify-start h-[25vh] overflow-hidden   bg-white border-2 border-slate-400 hover:overflow-scroll rounded-2xl items-start "
    >
